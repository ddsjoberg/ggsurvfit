...
- Now exporting the utility function
  [`ggsurvfit_align_plots()`](http://www.danieldsjoberg.com/ggsurvfit/dev/reference/ggsurvfit_align_plots.md)
...
- Added S3 methods
  [`grid.draw.ggsurvfit()`](http://www.danieldsjoberg.com/ggsurvfit/dev/reference/grid.draw_ggsurvfit.md)
  and
  [`grid.draw.ggcuminc()`](http://www.danieldsjoberg.com/ggsurvfit/dev/reference/grid.draw_ggsurvfit.md)
